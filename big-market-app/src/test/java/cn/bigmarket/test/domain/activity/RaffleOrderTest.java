package cn.bigmarket.test.domain.activity;
...
import cn.bigmarket.domain.activity.service.IRaffleOrder;
...
public class RaffleOrderTest {
     ...
     * 2. 清空 redis 缓存 flush all
     * 3. for 循环 20 次，消耗完库存，最终数据库剩余库存为0
     */
    @Test
